...
CONTAINER_REGISTRY_IMAGE=us-east1-docker.pkg.dev/inspired-skill-371914/ar-personal-streamlit-apps/$appname:$dte
...
gcloud run deploy cr-personal-streamlit-na-$appname \
